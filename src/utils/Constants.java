...
public class Constants 
{
	...
	public static final String PERCEP_TXT_WINDU = "Apenas has podido alzar el arco cuando el WINDU se ha abalanzado sobre ti.";
	public static final String PERCEP_TXT_ORO = "Tienes ante ti el misterioso tesoro del WINDU";
	public static final String PERCEP_TXT_GRITO = "Suena fuerte un alarido monstruoso, la bestia esta cerca";
	public static final String PERCEP_TXT_MURO = "Un muro no te deja avanzar";
	
	//Textos intermedios y de fin
	
	public static final String INTERMEDIO_TXT_ORO = "Ya tienes el tesoro del WINDU \n Corre y escapa con el";
